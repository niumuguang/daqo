...
#include <afxext.h>
#include "..\daqo\daqoDoc.h"
#include "..\daqo\daqoView.h"
...
public:
	virtual HRESULT InitializeDocumentPreview(HWND hWndParent, RECT* prc)
	{
		...
		CCreateContext ctx;
		ctx.m_pNewViewClass = RUNTIME_CLASS(CdaqoView);
		...
		m_pDocument->AddRef();
		ctx.m_pCurrentDoc = DYNAMIC_DOWNCAST(CdaqoDoc, (CObject*) m_pDocument->GetContainer());
